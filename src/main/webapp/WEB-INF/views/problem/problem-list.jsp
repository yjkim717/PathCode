...
<head>
    ...
    <title>Problem List | PathCode</title>
    ...
    <style>
        ...
        .btn-info:hover {
            transform: translateY(-2px);
            box-shadow: 0 7px 14px rgba(14, 165, 233, 0.4);
        }
        ...
        .btn-solved:hover, .btn-solved.active {
...
<body>
    ...
    <div class="container mt-5 animate-fade-in">
        <%-- <div class="d-flex justify-content-between align-items-center mb-4">
            <h2><i class="fas fa-project-diagram mr-2"></i>Problem List</h2>
            <a href="${pageContext.request.contextPath}/problem/new" class="btn btn-primary">
                <i class="fas fa-plus mr-2"></i> Add New Problem
            </a>
        </div> --%>

        <div class="card shadow">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h6 class="m-0 font-weight-bold"><i class="fas fa-file-code mr-2"></i>Problems</h6>
                <!-- <div class="input-group search-box-container">
                    <input type="text" class="form-control search-input" placeholder="Search problems..." id="problemSearchInput">
            ...
            <div class="card-body">
                        ...
                        <tbody>
                            <c:forEach var="problem" items="${problems}">
                                <tr>
                                    <td>${problem.title}</td>
                                    <td>
                                        <span class="badge ${problem.difficulty == 'Easy' ? 'badge-easy' : 
                                    ...
                                    <td>
                                        <span class="badge ${problem.premium ? 'badge-premium' : ''}">
                                            ${problem.premium ? 'Yes' : 'No'}
                                        </span>
                                    </td>
                                    <td>
                                        <!-- Get progress status -->
                                        <c:set var="status" value="${progressMap[problem.problemId]}" />

                                        <!-- View link -->
                                        <a href="${problem.questionLink}" target="_blank" class="btn btn-info btn-sm mr-2">
                                            <i class="fas fa-external-link-alt mr-1"></i> View
                                        </a>

                                        <!-- Status Buttons -->
                                        <a href="${pageContext.request.contextPath}/progress/mark-solved?userId=${sessionScope.userID}&problemId=${problem.problemId}"
                                           class="btn btn-status btn-solved btn-sm ${status == 'solved' ? 'active' : ''}">
                                            <i class="fas fa-check-circle mr-1"></i> Solved
                                        </a>

                                        <a href="${pageContext.request.contextPath}/progress/mark-inprogress?userId=${sessionScope.userID}&problemId=${problem.problemId}"
                                           class="btn btn-status btn-progress btn-sm ${status == 'inprogress' ? 'active' : ''}">
                ...
                <c:if test="${empty problems}">
                    <div class="empty-state">
                        ...
                        <h5 class="mt-3">No problems found</h5>
                        <p>Click the "Add New Problem" button to get started.</p>
                    </div>
                </c:if>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-4 mb-md-0">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="${pageContext.request.contextPath}/problem/list"><i class="fas fa-angle-right mr-2"></i> Problems</a></li>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#problemSearchInput").on("keyup", function() {
