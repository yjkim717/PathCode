...
<head>
    ...
    <title>Problem Details | PathCode</title>
        ...
        <c:if test="${not empty problem}">
            <div class="card shadow">
                <div class="card-header">
                    <h4 class="m-0"><i class="fas fa-eye mr-2"></i>Problem Details</h4>
                </div>
                <div class="card-body">
                    ...
                    <div class="detail-item">
                        <span class="label-icon"><i class="fas fa-percentage"></i></span>
                    ...
                    <div class="detail-item">
                        ...
                        <span class="badge" style="background-color: rgba(245, 158, 11, 0.2); color: var(--accent-amber);">
                    ...
                    <div class="detail-item">
                        ...
                        <a href="${problem.questionLink}" target="_blank" style="color: var(--accent-blue);">
                            View Problem <i class="fas fa-external-link-alt ml-1"></i>
                        </a>
                    </div>
                    
                    <div class="detail-item">
                        <span class="label-icon"><i class="fas fa-lightbulb"></i></span>
                        <strong>Solution:</strong>
                        <a href="${problem.solutionLink}" target="_blank" style="color: var(--accent-blue);">
                            View Solution <i class="fas fa-external-link-alt ml-1"></i>
                        </a>
                    </div>

                    <div class="mt-4 text-center">
                        <%-- <a href="${pageContext.request.contextPath}/problem/edit?id=${problem.problemId}" 
                           class="btn btn-warning mr-3">
                            <i class="fas fa-edit mr-2"></i> Edit
                        </a> --%>
                        <a href="${pageContext.request.contextPath}/problem/list" 
        ...
        <c:if test="${empty problem}">
            <div class="card shadow">
                <div class="card-body text-center">
                    ...
                    <p class="text-muted">The requested problem could not be found.</p>
                    <a href="${pageContext.request.contextPath}/problem/list" class="btn btn-secondary mt-3">
                        <i class="fas fa-arrow-left mr-2"></i> Back to Problem List
                    </a>
                </div>
            </div>
        </c:if>
